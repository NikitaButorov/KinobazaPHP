                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        <td class="col-lg-1 col-md-1 col-xs-2">
                            <img src="/KINOBAZAPHP/assets/img/inter.png" alt="Интестеллар"
                                 class="img-responsive img-thumbnail">
                        </td>
                        <td class="vert-align"><a href="/KINOBAZAPHP/views/Inter.php">Интестеллар</a></td>
                        <td class="text-center vert-align">2015</td>
                        <td class="text-center vert-align"><span class="badge">8.1</span></td>
                    </tr>
                    <tr>
                        <td class="col-lg-1 col-md-1 col-xs-2">
                            <img src="/KINOBAZAPHP/assets/img/cloud.png" alt="Облачный атлас"
                                 class="img-responsive img-thumbnail">
                        </td>
                        <td class="vert-align"><a href="/KINOBAZAPHP/views/atlas.php">Облачный атлас</a></td>
                        <td class="text-center vert-align">2012</td>
                        <td class="text-center vert-align"><span class="badge">8.0</span></td>
                    </tr>
                    <tr>
                        <td class="col-lg-1 col-md-1 col-xs-2">
                            <img src="/KINOBAZAPHP/assets/img/matrix.png" alt="Матрица"
                                 class="img-responsive img-thumbnail">
                        </td>
                        <td class="vert-align"><a href="/KINOBAZAPHP/views/matrix.php">Матрица</a></td>
                        <td class="text-center vert-align">2002</td>
                        <td class="text-center vert-align"><span class="badge">7.9</span></td>
                    </tr>
                    <tr>
                        <td class="col-lg-1 col-md-1 col-xs-2">
                            <img src="/KINOBAZAPHP/assets/img/max.png" alt="Безумный макс"
                                 class="img-responsive img-thumbnail">
                        </td>
                        <td class="vert-align"><a href="/KINOBAZAPHP/views/max.php">Безумный макс</a></td>
                        <td class="text-center vert-align">2015</td>
                        <td class="text-center vert-align"><span class="badge">8.0</span></td>
                    </tr>
