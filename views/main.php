    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-9 col-lg-push-3">
                ...
                ?>
                <div class="margin-8"></div>
                <a href="/KINOBAZAPHP/html/Inter_show.php"><h3>Как снимали Интерстеллар<h3></a>
                <hr>
                <p>
                ...
                <a href="/KINOBAZAPHP/html/Inter_show.php" class="btn btn-warning pull-right">читать</a>

                <div class="margin-8"></div>
                <a href="/KINOBAZAPHP/html/Tom.php"><h3>Актер Том Хенкс поделился впечатлением о фестивале</h3></a>
                <hr>
                <p>
                    16 февраля в Лондоне состоялась 67-я церемония вручения наград Британской киноакадемии. Леонардо ДиКаприо, Брэд Питт, Анджелина Джоли, Кейт Бланшетт, Хелен Миррен, Эми Адамс, Кристиан Бэйл, Альфонсо Куарон и другие гости и победители премии — в нашем репортаже.
                </p>
                <a href="/KINOBAZAPHP/html/Tom.php" class="btn btn-warning pull-right">читать</a>
