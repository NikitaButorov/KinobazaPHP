                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        <td class="col-lg-1 col-md-1 col-xs-2">
                            <img src="/KINOBAZAPHP/assets/img/breakingbad.png" alt="во все тяжкие"
                                 class="img-responsive img-thumbnail">
                        </td>
                        <td class="vert-align"><a href="/KINOBAZAPHP/views/risk.php">Во все тяжкие</a></td>
                        <td class="text-center vert-align">2008</td>
                        <td class="text-center vert-align"><span class="badge">8.1</span></td>
                    </tr>
                    <tr>
                        <td class="col-lg-1 col-md-1 col-xs-2">
                            <img src="/KINOBAZAPHP/assets/img/xfiles.png" alt="секретные материалы"
                                 class="img-responsive img-thumbnail">
                        </td>
                        <td class="vert-align"><a href="/KINOBAZAPHP/views/secret.php">Секретные материалы</a></td>
                        <td class="text-center vert-align">1993</td>
                        <td class="text-center vert-align"><span class="badge">8.0</span></td>
                    </tr>
                    <tr>
                        <td class="col-lg-1 col-md-1 col-xs-2">
                            <img src="/KINOBAZAPHP/assets/img/silicon.png" alt="силиконовая долина"
                                 class="img-responsive img-thumbnail">
                        </td>
                        <td class="vert-align"><a href="/KINOBAZAPHP/views/silicon.php">Силиконовая долина</a></td>
                        <td class="text-center vert-align">2014</td>
                        <td class="text-center vert-align"><span class="badge">7.9</span></td>
                    </tr>
                    <tr>
                        <td class="col-lg-1 col-md-1 col-xs-2">
                            <img src="/KINOBAZAPHP/assets/img/dead.png" alt="ходячие мертвецы"
                                 class="img-responsive img-thumbnail">
                        </td>
                        <td class="vert-align"><a href="/KINOBAZAPHP/views/zombi.php">Ходячие мертвецы</a></td>
